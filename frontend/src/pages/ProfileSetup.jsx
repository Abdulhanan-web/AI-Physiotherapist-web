...
const medicalHistoryOptions = ["None","Diabetes","Hypertension","Arthritis","Heart Disease","Previous Surgery","Osteoporosis"];
        ...
        if (res.ok) {
          ...
          if (data.profile_completed && data.profile) {
            ...
            setFormData({
              ...
              height: p.height || "", weight: p.weight || "", injury_type: p.injury_type || "",
  ...
  return (
    <div className="page profile-page">
      ...
      <div style={{ maxWidth: 800, margin: "32px auto 0" }}>
        <h1 className="page-title" style={{ color: isExisting ? "var(--accent-green-dim)" : "var(--accent-green)" }}>
        ...
        <form onSubmit={handleSubmit} style={{ marginTop: 32, display: "flex", flexDirection: "column", gap: 14 }}>
          <div className="profile-form-grid">
            <input name="full_name" placeholder="Full Name" value={formData.full_name} onChange={handleChange} required className="form-input" />
            <input name="age" type="number" placeholder="Age" value={formData.age} onChange={handleChange} required className="form-input" />
          </div>
          ...
          <div className="profile-form-grid">
            ...
            <input name="height" type="number" placeholder="Height (cm)" value={formData.height} onChange={handleChange} required className="form-input" />
          </div>

          <div className="profile-form-grid">
            <input name="weight" type="number" placeholder="Weight (kg)" value={formData.weight} onChange={handleChange} required className="form-input" />
          ...
          <select name="medical_history" value={formData.medical_history} onChange={handleChange} className="form-select">
